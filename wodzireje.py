...
class PlanujemyWesele(scrapy.Spider):
    ...
    start_urls = [
        'https://www.planujemywesele.pl/katalog/1/kategoria/dj-wodzirej-na-wesele/miasto/lublin,368/cena/1500,/liczba-osob/2,/gatunki-muzyczne/disco',
        'https://www.planujemywesele.pl/katalog/1/kategoria/dj-wodzirej-na-wesele/miasto/tomaszow-lubelski,740/cena/1500,/liczba-osob/2,/gatunki-muzyczne/disco'
    ]
    ...
    def parse_details(self, response):
        ...
        cost = string.join(response.css('div.presentation > div.row-minus').css('span::text').extract(), ' ')

        yield { 'page': response.url, 'title': name, 'motto': motto, 'tel': tel, 'www': www, 'social': social, 'city': city, 'regions': regions, 'cost': cost }
